...
public class HostEventListeners extends RequestListener {
  ...
  @OnEvent("CREATE_GAME")
  public void onCreateGame(SocketIOClient client, JoinGameEvent joinGameEvent) {
    userActionController.createGame(client, joinGameEvent.getName());
  }

  @OnEvent("START_GAME")
  public void onStartGame(SocketIOClient client, GameIdentityPayload game) {
    userActionController.startGame(client, game.getGameId());
  }
